...
class ML:
    ...
    def load_balancer(self, new_model):
        ...
        least_frequent_model = min(self.requests_processed, key=self.requests_processed.get)
        self.loaded_models.pop(least_frequent_model)
        self.loaded_models[new_model] = self.load_weights(new_model)
        self.requests_processed[new_model] = self.requests_processed.pop(least_frequent_model)
